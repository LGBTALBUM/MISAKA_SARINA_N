...
export const businessProcess = [
  {
    title: 'Brief',
    body: 'Share the project goal, reference links, expected outcome, deadline, budget range, and any technical constraints.'
  },
  {
    title: 'Scope',
    body: 'I turn the brief into a small, concrete scope: deliverables, timeline, assumptions, and what is explicitly outside the project.'
  },
  {
    title: 'Build',
    body: 'The work is executed in small reviewable steps, with notes kept clear enough for later maintenance or handoff.'
  },
  {
    title: 'Archive',
    body: 'Final outputs should remain understandable after launch: links, changelogs, deployment notes, and usage notes are kept close to the work.'
  }
];
